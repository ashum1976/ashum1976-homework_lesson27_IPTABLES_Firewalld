...
- TRACE - Трассировка прохождения пакета по цепочкам. Включается в таблице raw. Должен писать вывод в файл /var/log/messages, если включить эту возможность в rsyslog.conf (строка: kern.* ..... /var/log/message).
